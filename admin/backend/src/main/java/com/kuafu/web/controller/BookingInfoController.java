...
public class BookingInfoController  {
    ...
    public BaseResponse importExcel(@RequestPart(name = "file") MultipartFile file)
    {
        ...
        if (StringUtils.equalsIgnoreCase(extension, "pdf")) {
            excelProvider.pdfData(file, BookingInfo.class, bookingInfoService::save);
        }
        else{
            excelProvider.importData(file, BookingInfo.class, bookingInfoService::save);
        }
    ...
    public BaseResponse deleteBatch(@RequestBody List<Integer> ids) {
        ...
        sequenceReset.resetIfEmpty("booking_info");
        return flag ? ResultUtils.success() : ResultUtils.error(ErrorCode.OPERATION_ERROR);
    }
}
