...
public class DynamicApiSettingController  {
    ...
    public BaseResponse importExcel(@RequestPart(name = "file") MultipartFile file)
    {
        ...
        if (StringUtils.equalsIgnoreCase(extension, "pdf")) {
            excelProvider.pdfData(file, DynamicApiSetting.class, dynamicApiSettingService::save);
        }
        else{
            excelProvider.importData(file, DynamicApiSetting.class, dynamicApiSettingService::save);
        }
    ...
    public BaseResponse deleteBatch(@RequestBody List<Integer> ids) {
        boolean flag = this.dynamicApiSettingService.removeByIds(ids);
        sequenceReset.resetIfEmpty("dynamic_api_setting");
        return flag ? ResultUtils.success() : ResultUtils.error(ErrorCode.OPERATION_ERROR);
    }
}
